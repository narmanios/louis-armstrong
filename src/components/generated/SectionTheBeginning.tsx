...
export const SectionTheBeginning: React.FC<SectionTheBeginningProps> = ({
  textBaseStyle,
}) => {
  return (
    <section
    ...
    >
      ...
      >
        ...
        >
          ...
          Armstrong and his Orchestra goes here. Text about Louis Armstrong and
          his Orchestra goes here.
        </p>
        <p
          style={{
            ...textBaseStyle,
